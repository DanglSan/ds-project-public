...
class ReplicaKey final :
 ...
 public:
  ...
  ~ReplicaKey() override;
  explicit constexpr ReplicaKey(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class LSeq final :
 ...
 public:
  ...
  ~LSeq() override;
  explicit constexpr LSeq(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SeekGetRequest final :
 ...
 public:
  ...
  explicit constexpr SeekGetRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class DBItems_DbItem final :
 ...
 public:
  ...
  explicit constexpr DBItems_DbItem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class DBItems final :
 ...
 public:
  ...
  ~DBItems() override;
  explicit constexpr DBItems(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class SyncGetRequest final :
 ...
 public:
  ...
  explicit constexpr SyncGetRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* ReplicaKey::release_snapshot_id() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = snapshot_id_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void Value::set_lseq(ArgT0&& arg0, ArgT... args) {
 ...
 lseq_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Value::_internal_set_lseq(const std::string& value) {
  ...
  lseq_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Value::_internal_mutable_lseq() {
  
  return lseq_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Value::release_lseq() {
  // @@protoc_insertion_point(field_release:lseqdb.Value.lseq)
  return lseq_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Value::set_allocated_lseq(std::string* lseq) {
  ...
  lseq_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), lseq,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (lseq_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
...
inline std::string* EventsRequest::release_lseq() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = lseq_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (lseq_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    lseq_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
