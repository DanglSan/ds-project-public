...
extern SnapshotIdDefaultTypeInternal _SnapshotId_default_instance_;
...
template<> ::lseqdb::SnapshotId* Arena::CreateMaybeMessage<::lseqdb::SnapshotId>(Arena*);
...
class SnapshotId final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:lseqdb.SnapshotId) */ {
 public:
  inline SnapshotId() : SnapshotId(nullptr) {}
  ~SnapshotId() override;
  explicit PROTOBUF_CONSTEXPR SnapshotId(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SnapshotId(const SnapshotId& from);
  SnapshotId(SnapshotId&& from) noexcept
    : SnapshotId() {
    *this = ::std::move(from);
  }

  inline SnapshotId& operator=(const SnapshotId& from) {
    CopyFrom(from);
    return *this;
  }
  inline SnapshotId& operator=(SnapshotId&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SnapshotId& default_instance() {
    return *internal_default_instance();
  }
  static inline const SnapshotId* internal_default_instance() {
    return reinterpret_cast<const SnapshotId*>(
               &_SnapshotId_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(SnapshotId& a, SnapshotId& b) {
    a.Swap(&b);
  }
  inline void Swap(SnapshotId* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SnapshotId* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SnapshotId* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SnapshotId>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SnapshotId& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const SnapshotId& from) {
    SnapshotId::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SnapshotId* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "lseqdb.SnapshotId";
  }
  protected:
  explicit SnapshotId(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:lseqdb.SnapshotId)
 private:
  class _Internal;
...
// optional string snapshot_id = 3;
inline bool ReplicaKey::_internal_has_snapshot_id() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool ReplicaKey::has_snapshot_id() const {
  return _internal_has_snapshot_id();
}
inline void ReplicaKey::clear_snapshot_id() {
  _impl_.snapshot_id_.ClearToEmpty();
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline const std::string& ReplicaKey::snapshot_id() const {
  // @@protoc_insertion_point(field_get:lseqdb.ReplicaKey.snapshot_id)
  return _internal_snapshot_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ReplicaKey::set_snapshot_id(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.snapshot_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:lseqdb.ReplicaKey.snapshot_id)
}
inline std::string* ReplicaKey::mutable_snapshot_id() {
  std::string* _s = _internal_mutable_snapshot_id();
  // @@protoc_insertion_point(field_mutable:lseqdb.ReplicaKey.snapshot_id)
  return _s;
}
inline const std::string& ReplicaKey::_internal_snapshot_id() const {
  return _impl_.snapshot_id_.Get();
}
inline void ReplicaKey::_internal_set_snapshot_id(const std::string& value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.snapshot_id_.Set(value, GetArenaForAllocation());
}
inline std::string* ReplicaKey::_internal_mutable_snapshot_id() {
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.snapshot_id_.Mutable(GetArenaForAllocation());
}
inline std::string* ReplicaKey::release_snapshot_id() {
  // @@protoc_insertion_point(field_release:lseqdb.ReplicaKey.snapshot_id)
...
inline void ReplicaKey::set_allocated_snapshot_id(std::string* snapshot_id) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:lseqdb.ReplicaKey.snapshot_id)
}
...
// string snapshot_id = 1;
inline void SnapshotId::clear_snapshot_id() {
  _impl_.snapshot_id_.ClearToEmpty();
}
inline const std::string& SnapshotId::snapshot_id() const {
  // @@protoc_insertion_point(field_get:lseqdb.SnapshotId.snapshot_id)
  return _internal_snapshot_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SnapshotId::set_snapshot_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.snapshot_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:lseqdb.SnapshotId.snapshot_id)
}
inline std::string* SnapshotId::mutable_snapshot_id() {
  std::string* _s = _internal_mutable_snapshot_id();
  // @@protoc_insertion_point(field_mutable:lseqdb.SnapshotId.snapshot_id)
  return _s;
}
inline const std::string& SnapshotId::_internal_snapshot_id() const {
  return _impl_.snapshot_id_.Get();
}
inline void SnapshotId::_internal_set_snapshot_id(const std::string& value) {
  
  _impl_.snapshot_id_.Set(value, GetArenaForAllocation());
}
inline std::string* SnapshotId::_internal_mutable_snapshot_id() {
  
  return _impl_.snapshot_id_.Mutable(GetArenaForAllocation());
}
inline std::string* SnapshotId::release_snapshot_id() {
  // @@protoc_insertion_point(field_release:lseqdb.SnapshotId.snapshot_id)
  return _impl_.snapshot_id_.Release();
}
inline void SnapshotId::set_allocated_snapshot_id(std::string* snapshot_id) {
  if (snapshot_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:lseqdb.SnapshotId.snapshot_id)
}
