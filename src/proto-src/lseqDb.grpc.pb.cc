...
static const char* LSeqDatabase_method_names[] = {
  ...
  "/lseqdb.LSeqDatabase/CreateSnapshotRequest",
...
LSeqDatabase::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_CreateSnapshotRequest_(LSeqDatabase_method_names[4], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status LSeqDatabase::Stub::CreateSnapshotRequest(::grpc::ClientContext* context, const ::google::protobuf::Empty& request, ::lseqdb::SnapshotId* response) {
  return ::grpc::internal::BlockingUnaryCall< ::google::protobuf::Empty, ::lseqdb::SnapshotId, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_CreateSnapshotRequest_, context, request, response);
}

void LSeqDatabase::Stub::async::CreateSnapshotRequest(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::lseqdb::SnapshotId* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::google::protobuf::Empty, ::lseqdb::SnapshotId, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CreateSnapshotRequest_, context, request, response, std::move(f));
}

void LSeqDatabase::Stub::async::CreateSnapshotRequest(::grpc::ClientContext* context, const ::google::protobuf::Empty* request, ::lseqdb::SnapshotId* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CreateSnapshotRequest_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::lseqdb::SnapshotId>* LSeqDatabase::Stub::PrepareAsyncCreateSnapshotRequestRaw(::grpc::ClientContext* context, const ::google::protobuf::Empty& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::lseqdb::SnapshotId, ::google::protobuf::Empty, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_CreateSnapshotRequest_, context, request);
}

::grpc::ClientAsyncResponseReader< ::lseqdb::SnapshotId>* LSeqDatabase::Stub::AsyncCreateSnapshotRequestRaw(::grpc::ClientContext* context, const ::google::protobuf::Empty& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncCreateSnapshotRequestRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
LSeqDatabase::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< LSeqDatabase::Service, ::google::protobuf::Empty, ::lseqdb::SnapshotId, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](LSeqDatabase::Service* service,
             ::grpc::ServerContext* ctx,
             const ::google::protobuf::Empty* req,
             ::lseqdb::SnapshotId* resp) {
               return service->CreateSnapshotRequest(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status LSeqDatabase::Service::CreateSnapshotRequest(::grpc::ServerContext* context, const ::google::protobuf::Empty* request, ::lseqdb::SnapshotId* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
